...
import tel.jeelpa.saipose.reference.loadData
...
class AnimePahe : AnimeParser() {
    ...
    class AnimePaheExtractor : VideoExtractor() {
        ...
        override suspend fun extract(server: VideoServer): VideoContainer {
            ...
            val size = data["size"]!!.toDoubleOrNull()
            val ref = data["referer"]!!
